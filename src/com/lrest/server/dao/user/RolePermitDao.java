...
//        sql.append(" funcTree.SEQ AS seq \n");
        ...
        sql.append(" funcTree.ID AS id, \n");
        sql.append(" funcTree.PID AS pid, \n");
        sql.append(" funcTree.FUNC_TITLE AS title, \n");
        sql.append(" funcTree.PLATFORM AS cash_display, \n");
        sql.append(" funcTree.FUNC_CODE AS name, \n");
        sql.append(" funcTree.SEQ AS sort \n");
        ...
        sql.append(" ORDER BY funcTree.SEQ \n");
